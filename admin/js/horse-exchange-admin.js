(function( $ ) {
    ...
    $(function(){
         ...
         var frame,
             ...
             imgUploadButton = $( '#upload_betfair_logo_button' ),    

             imgContainer = $( '#upload_logo_preview' ),

             imgIdInput = $( '#betfair_logo_id' ),

             imgPreview = $('#upload_logo_preview'),        

             imgDelButton = $('#betfair_delete_logo_button'),

             // Color Pickers Inputs

             colorPickerInputs = $( '.betfair-color-picker' );



         // WordPress specific plugins - color picker and image upload

         $( '.betfair-color-picker' ).wpColorPicker();
        ...
        // wp.media add Image
         ...
         imgUploadButton.on( 'click', function( event ){
            ...
            frame = wp.media({
              ...
              title: 'Select or Upload Media for your Betfair Logo',

              button: {

                text: 'Use as my Betfair Logo'
