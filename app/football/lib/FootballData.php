...
class FootballData {
     ...
     */    
    public function findMatchesForDateRange($start, $end, $competition_id) {
        $resource = 'matches/?dateFrom=' . $start . '&dateTo=' . $end . '&competitions=' . $competition_id;
    ...
    public function findAwayMatchesByTeam($teamId) {
        $resource = 'teams/' . $teamId . '/matches/?venue=AWAY';
        //http://api.football-data.org/v2/teams/62/matches?venue=home
    ...
    public function findUpcomingMatchesByTeam($teamId, $limit) {
        $resource = 'teams/' . $teamId . '/matches/?status=SCHEDULED&limit='. $limit;
        //http://api.football-data.org/v2/teams/62/matches?venue=home
        ...
        public function findLiveMatchesByTeam($teamId, $limit) {
        $resource = 'teams/' . $teamId . '/matches/?status=IN_PLAY&limit='. $limit;
        //http://api.football-data.org/v2/teams/62/matches?venue=home
